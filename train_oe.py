...
if __name__ == '__main__':
    ...
    ood_data = DnapepDataset(
        file_path=args.ood_file,
        type='test', use_embed=args.use_embed)
    ...
    ood_loader = data.DataLoader(ood_data, batch_size=args.batch_size, shuffle=True, num_workers=4)
    ...
    train(train_loader, ood_loader, val_loader, test_loader, model, optimizer, args)
